...
class FlutterPluginRecordPlus {
  final MethodChannel _channel = const MethodChannel('flutter_plugin_record_plus');

  static final _uuid = new Uuid();
  String id = '';
  static final alis = new Map<String, FlutterPluginRecordPlus>();
  ...
  static Future<dynamic> _handler(MethodCall methodCall) async{
    ...
    FlutterPluginRecordPlus recordPlugin = alis[id] ?? FlutterPluginRecordPlus();
